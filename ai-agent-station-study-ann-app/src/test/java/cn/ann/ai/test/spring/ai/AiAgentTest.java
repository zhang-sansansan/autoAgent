...
public class AiAgentTest {
    ...
    public void init() {
        ...
        chatModel = OpenAiChatModel.builder()//智能体思考的头脑
                .openAiApi(openAiApi)
        ...
        chatClient = ChatClient.builder(chatModel)//智能体的躯干
                //人设
                .defaultSystem("""
...
//                .defaultTools(new SyncMcpToolCallbackProvider(sseMcpClient01(), sseMcpClient02()))
    ...
    public McpSyncClient stdioMcpClient() {//本地直连模式

        // based on
        // https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem
        //构建一个启动参数
        var stdioParams = ServerParameters.builder("npx")
                .args("-y", "@modelcontextprotocol/server-filesystem", "D:/桌面/文档/文档盘/aiworkspace", "D:/桌面/文档/文档盘/aiworkspace")
                .build();

        //创建客户端    StdioClientTransport表示通过“标准输入输出流”通信，而不是网络端口
    ...
    public McpSyncClient sseMcpClient01() {//远程网络模式

        //HttpClientSseClientTransport通过 HTTP协议的 SSE (Server-Sent Events) 技术通信
