...
export function useEditorProps(
  ...
  onContentChangeCallback?: (json: FlowDocumentJSON) => void
): FreeLayoutProps {
  return useMemo<FreeLayoutProps>(
    () => ({
      ...
      onContentChange: debounce((ctx) => {
        if (onContentChangeCallback) {
          onContentChangeCallback(ctx.document.toJSON());
        }
      }, 1000),
      /**
       * Running line
      ...
      plugins: () => [
        ...
        createMinimapPlugin({
          ...
          canvasStyle: {
            ...
            canvasHeight: 102,
            canvasPadding: 50,
            canvasBackground: 'rgba(12, 15, 25, 0.98)',
            canvasBorderRadius: 10,
            viewportBackground: 'rgba(139, 92, 246, 0.11)',
            viewportBorderRadius: 4,
            viewportBorderColor: 'rgba(167, 139, 250, 0.46)',
            viewportBorderWidth: 1,
            viewportBorderDashLength: undefined,
            nodeColor: 'rgba(167, 174, 196, 0.32)',
            nodeBorderRadius: 2,
            nodeBorderWidth: 0.145,
            nodeBorderColor: 'rgba(151, 160, 198, 0.22)',
            overlayColor: 'rgba(7, 9, 16, 0.34)',
          },
    ...
    [initialData, nodeRegistries, onContentChangeCallback]
  );
}
